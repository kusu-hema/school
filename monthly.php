...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $bibletraining = $_POST['bibletraining'] ?? '';
    ...
    <div class='row'>
        ...
        <p class='details'>
            ...
            <span class='bottom-border'>$churchname</span>
              ...
              <p class='details'>
            <span class='label'
              >Does Your Wife Support Your Training
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
             
              : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
            >
            <span class='bottom-border'>$support</span>
          </p>
          ...
          <p class='details'>
            <span class='label'
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
            >
            <span class='bottom-border'>$Contribution</span>
          </p>
          ...
          <p class='details'>
            <span class='label'
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
            >
            <span class='bottom-border'>$Attendance</span>
          </p>

     
            <p class='details'>
            <span class='label'
              >Have You Had Any Bible Training &nbsp;&nbsp;&nbsp;&nbsp; 
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
            >
            <span class='bottom-border'>$bibletraining</span>
          </p>
          <p class='details'>
            <span class='label'
              >Phone &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <p class='details'>
            <span class='label'
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
            >
            <span class='bottom-border'>$churchAddress</span>
          </p>
    ...
    try {
        ...
        $mail->Body = "
            ...
            <p><strong>Does Your Wife Support Your Training:</strong> $support</p>
            <p><strong>Aim To Join :</strong> $aim</p>          

            <p><strong>Weekly Contribution:</strong>$Contribution</p>
            <p><strong>Weekly Attendance:</strong> $Attendance</p>
            <p><strong>Have You Had Any Bible Training:</strong> $bibletraining</p>

            <p><strong>Phone:</strong> $Phone</p>
            <p><strong>Have You Had Any Bible Training:</strong> $bibletraining</p>

            <p><strong>Your Church Address:</strong> $churchAddress</p>
        ";

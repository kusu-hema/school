...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Add the title
    $pdf->Cell(0, 10, 'Application For Admission Into English Medium BIBLE Training', 0, 1, 'C');
    ...
    <div class='row'>
          ...
          <p> <strong> NOTE: </strong> Seeking Admission Into 3 Years</p>
    ...
    $pdfString = $pdf->Output('English_Medium_BIBLE_Training.pdf', 'S');
    ...
    try {
        ...
        // Attach the PDF
        $mail->addStringAttachment($pdfString, 'English_Medium_BIBLE_Training.pdf');

        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Application For Admission Into English Medium BIBLE Training';
        $mail->Body = "
